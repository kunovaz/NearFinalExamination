package kukiat.krirk.ac.th.nearfinalexamination.fragment;
...
import kukiat.krirk.ac.th.nearfinalexamination.MainActivity;
import kukiat.krirk.ac.th.nearfinalexamination.R;

/**
 * Created by Cnz on 27/02/2018.
 */
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (moneyString.isEmpty()) {
                    ...
                    String anwserSring = Double.toString(answerADouble);

                    Toast.makeText(getActivity(), "Your " + moneyString + " USD == > " + anwserSring + " THB",
